...
- [x] T034 运行 `specs/004-zero-markup-i18n/quickstart.md` 全流程验证并记录结果（含 autoScan:false 存量兼容与生产构建验证）
- [x] T035 [P] 更新 `specs/004-zero-markup-i18n/checklists/requirements.md` 与 spec.md 状态为 Complete（沿用 specs/003 收尾惯例）
